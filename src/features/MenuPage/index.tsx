...
const MenuPage = () => {
  return (
    <>
    <Header showThemeToggle={true} showBurgerIcon={false} />
          <ul>
            <li>
            ...
            <li>
              <a href={PROPOSE_CHANGES_PATH} target="_blank" rel="noopener noreferrer">
                Propose changes
              </a>
            </li>
            <li>
              <a href={SAY_THANKS_PATH} target="_blank" rel="noopener noreferrer">
                Say thanks
              </a>
            </li>
            <li>
